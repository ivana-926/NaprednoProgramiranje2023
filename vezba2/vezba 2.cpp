...
int index = 0;
//  imame sostavuvanje na spil karti
for (int i = 0; i < 4; i++) {
...
/*  Ivana Belokozovska INKI926
    Ovoj algoritam dejstvuva taka sto gi spojuva trite stringovi suits, ranks i jokers vo eden string sto ni go oznacuva spilot karti
	deck so golemina od 54.
	Isto taka za meshanjeto na kartite se koristat navedenite funkcii od <cstdlib> bibliotekata	t.e. rand() i srand().
